...
// which this reuses). Gated on timetable.view.own — the quick daily
// glance; the full weekly view is the "My Schedule" nav page
// (/lecturer/timetable), which reuses the same getMyTimetableForLecturer
// query.
