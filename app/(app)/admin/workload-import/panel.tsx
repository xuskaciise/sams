...
import { SendTimetableReadyCard } from "../auto-timetable/send-timetable-ready-card";
...
export async function WorkloadImportPanel() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {canGenerate && <SendTimetableReadyCard semesterNumberOptions={semesterNumberOptions} />}
