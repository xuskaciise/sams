...
function GridCell({
  ...
  const droppable = useDroppable({ id: cellId(row.id, day), data: { type: "cell" as const, rowId: row.id, day }, disabled: !interactive });

  const compact = scale === "compact";

  return (
    <div
      ref={interactive ? droppable.setNodeRef : undefined}
